...
class CSCAUNet(nn.Module):
    def __init__(self, in_channels, n_class=1, decay=2):
        ...
        self.dp5 = nn.Conv2d(512, n_class, 1)
        self.dp4 = nn.Conv2d(256, n_class, 1)
        self.dp3 = nn.Conv2d(128, n_class, 1)
        self.dp2 = nn.Conv2d(64, n_class, 1)
...
if __name__ == '__main__':
    model = CSCAUNet(1, 2)
    summary(model, (1, 352, 352), batch_size=1, device='cpu')
